...
class Bl3pApi:
    ...
    def get_last_deposit_address(self):
    ...
    # Get the history of all orders.
    # @method get_all_active_orders
    # @param  market        'BTC'
    # @return array of orders
    def get_orders_history(self, market):
        return self.api_call("%sEUR/money/orders/history" % market, {})
...
public_key = '87aa8e55-15f0-4596-969b-2c6a9066a7c8'
secret_key = keyring.get_password('pybl3p', public_key)

b = Bl3pApi('https://api.bl3p.eu/1/', public_key, secret_key)

# pprint(b.get_balances())
pprint(b.get_orders_history('BTC'))